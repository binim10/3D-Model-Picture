...
public class GeometriesTest {
    ...
    public void findIntersections() {
        ...
        List<GeoPoint> result1 = _geometries.findIntersections(new Ray(new Point3D(2.6491820366597, -2.1421103028843, 0),
        ...
        List<GeoPoint> result11 = _geometries.findIntersections(new Ray(new Point3D(2.6491820366597, -2.1421103028843, 0),
        ...
        List<GeoPoint> result12 = _geometries.findIntersections(new Ray(new Point3D(2.6491820366597, -2.1421103028843, 0),
        ...
        List<GeoPoint> result13 = _geometries.findIntersections(new Ray(new Point3D(3, -3, 0),
                new Vector(1, 0, 0)));
